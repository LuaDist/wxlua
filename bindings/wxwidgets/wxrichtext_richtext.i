...
%class %delete %noclassinfo %encapsulate wxRichTextRange
...
%class %delete %noclassinfo %encapsulate wxTextAttrEx, wxTextAttr
...
%class %delete %noclassinfo %encapsulate wxRichTextAttr
...
%class %delete %encapsulate %noclassinfo wxRichTextLine
...
%class %delete %noclassinfo wxRichTextRenderer, wxObject
    //wxRichTextRenderer() {}
...
%class %delete %noclassinfo wxRichTextStdRenderer, wxRichTextRenderer
