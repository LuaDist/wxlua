...
// RCS-ID:      $Id: wxlua.cpp,v 1.56 2009/01/06 21:17:18 jrl1 Exp $
...
static const wxCmdLineEntryDesc cmdLineDesc[] =
{
    ...
    { wxCMD_LINE_SWITCH, wxT("m"), wxT("msgdlg"), wxT("Print output to a message dialog."),
        wxCMD_LINE_VAL_NONE, wxCMD_LINE_PARAM_OPTIONAL },

    { wxCMD_LINE_SWITCH, wxT("c"), wxT("console"), wxT("Print output to a persistent message console."),
        wxCMD_LINE_VAL_NONE, wxCMD_LINE_PARAM_OPTIONAL },
